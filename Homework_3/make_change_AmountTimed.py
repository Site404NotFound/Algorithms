...
def finished(startTime, amount):
    print("Amount: {}".format(amount))                                          # Output the amount to the screen
...
if __name__ == "__main__":
    amounts = 10000                                                             # Create array variable for amounts
    denominations = [1, 5, 10, 25]                                              # Create variable for denominations (used standard USD coins)
    for count in range (10):                                                    # Breaks the arrays into pair (one list of denominations and one amount)
        ...
        finished(startTime, amounts)                                            # Call function that outputs a completion message to the monitor
        amounts += 10000                                                        # Increment amount by 10000
