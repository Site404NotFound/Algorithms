...
def finished(startTime, amount, denominations):
    print("Amounts: {}".format(amounts))                                        # Output the denominations length to the screen
...
if __name__ == "__main__":
    amounts = 100                                                               # Create array variable for amounts
    n = 100                                                                     # Set a value to increase the incrementing value of denominations
    for count in range (10):                                                    # Breaks the arrays into pair (one list of denominations and one amount)
        ...
        finished(startTime, amounts, denominations)                             # Call function that outputs a completion message to the monitor
        amounts += 100
        n += 100
